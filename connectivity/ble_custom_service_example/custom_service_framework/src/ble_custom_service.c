...
/*
 * Function used to send notifications to the peer devices for a specific attribute handle.
 *
 * \note A peer device will be notified only if it has enabled notifications explicitly.
 *
 */
