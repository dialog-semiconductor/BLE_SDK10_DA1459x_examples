...
static void system_init( void *pvParameters )
{
        ...
        /* Create a task to perform HASH operations. */
        status = OS_TASK_CREATE( "CRYPTO-HASH",         /* The text name assigned to the task, for
                                                           debug only; not used by the kernel. */
                        prvCRYPTO_HASH,                 /* The function that implements the task. */
        ...
        /* Create a task to perform AES operations */
        status = OS_TASK_CREATE( "CRYPTO-AES",          /* The text name assigned to the task, for
                                                           debug only; not used by the kernel. */
                        prvCRYPTO_AES,                  /* The function that implements the task. */
                        ( void * ) 0,                   /* The parameter passed to the task. */
                        1024,
                                                        /* The number of bytes to allocate to the
                                                           stack of the task. */
        ...
        /* The work of the SysInit task is done; The task will be terminated. */
