 ...
 *
 * @brief DSPS BLE central demo implements the scanner/client role of Serial Port Service.
...
{
        const char props_str[] = "BRXWNISE"; // Each letter corresponds to single property
        static char buf[9];
        int i;
...
OS_TASK_FUNCTION(dsps_central_task, pvParameters)
{
        int8_t wdog_id;
        ...
        ble_gap_device_name_set("Renesas SPS Demo Host", ATT_PERM_READ);
