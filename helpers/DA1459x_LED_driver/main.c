...
/* LED D1 status */
PRIVILEGED_DATA volatile static bool LED_status = 0;
 ...
 */
/* $code_snippet START the_main_task_in_SysInit_the_prvTemplateTask */
static OS_TASK_FUNCTION(prvTemplateTask, pvParameters)
{
        ...
        for ( ;; ) {
                ...
                hw_gpio_configure_pin(LED1_PORT, LED1_PIN, LED1_MODE, LED1_FUNC, LED_status);
