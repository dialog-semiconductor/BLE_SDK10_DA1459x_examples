...
/*
 * User-defined MemManage fault handler. This is the 2nd part of the handler written in
...
void MemManage_HandlerC(uint32_t *fault_args, uint32_t fp_context)
{
        ...
        *MTB_MASTER_REG = MTB_MASTER_REG_DISABLE_VAL;
        ...
        /* Memory Management Address Register (MMFAR) */
        __UNUSED volatile uint32_t mem_fault_addr = 0;;
        /* Memory Management Fault Status Register (MMFSR) */
        __UNUSED volatile uint8_t mem_fault_status = _FLD2VAL(SCB_CFSR_MEMFAULTSR, SCB->CFSR);
